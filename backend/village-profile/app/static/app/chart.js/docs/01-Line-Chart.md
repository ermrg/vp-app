...
// and the Line analytics defaults, but this particular instance will have `bezierCurve` set to false.
```
...
// This new data will now animate at the end of the analytics.
```
...
// The analytics will remove the first point and animate other points into place
```
